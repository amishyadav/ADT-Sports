        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-lg-8">
                        <h5>{{ __('messages.system_information.server_software') }}</h5>
                    </div>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8">
                        <h5>{{ __('messages.system_information.server_ip_address') }}</h5>
                    </div>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8">
                        <h5>{{ __('messages.system_information.server_protocol') }}</h5>
                    </div>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-4">
