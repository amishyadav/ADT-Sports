                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 mb-5">
                                    ...
                                    {{ Form::text('name', null, ['id'=>'addEmailName','class' => 'form-control','required','readonly','placeholder' => __('Name')]) }}
                                </div>
                                <div class="col-sm-12 mb-5">
                                ...
                                <div class="col-sm-12 mt-20">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-center">
                                        <input class="form-check-input h-20px w-30px" type="checkbox" name="status" value="1"
