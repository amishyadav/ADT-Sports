							    		...
							    		<div id="mega-blog-slider" class="mega-blog-slider">
											...
											<div class="item">
												...
												<div class="large-post-img">
													<img src="{{asset('front/images/blog-grid-view/img-2-1.jpg')}}" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="{{asset('front/images/blog-grid-view/img-2-2.jpg')}}" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="{{asset('front/images/blog-grid-view/img-2-3.jpg')}}" alt="">
												</div>
												<!-- Post Img -->
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="{{asset('front/images/blog-grid-view/img-2-4.jpg')}}" alt="">
												</div>
												<!-- Post Img -->
...
<nav id="menu" class="responive-nav">
	<a class="r-nav-logo" href="home-1.html"><img src="{{asset('front/images/logo-1.png')}}" alt=""></a>
