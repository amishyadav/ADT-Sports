@extends('layouts.app')
@section('title')
    {{ __('messages.sms_template.template_name') }}
@endsection
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 mb-5">
                                    <label for="description" class="form-label">{{ __('messages.sms_template.message') }}
                                        :</label>
                                    <textarea class="form-control" placeholder="{{ __('messages.sms_template.message') }}"
