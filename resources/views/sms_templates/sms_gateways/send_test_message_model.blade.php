<div id="sendTestMessageModel" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {{ Form::open(['id'=>'sendTestMessageForm','files' => 'true']) }}
            <div class="modal-body">
                <div class="alert alert-danger d-none hide" id="validationErrorsBox"></div>
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        {{ Form::label('mobile_number', __('Send To').(':'), ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('mobile_number', null, ['id'=>'mobileNumber','class' => 'form-control','required' ,'placeholder' => __('Mobile Number')]) }}
                    </div>
                </div>
            </div>
