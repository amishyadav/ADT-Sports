                    ...
                    <form action="{{ route('referrals.store') }}" method="POST">
                        ...
                        <div class="p-5">
                            ...
                            <div class="row mt-3 mb-5">
                                <div class="col-md-6">
                                    <input type="number" name="level" placeholder="{{__('messages.referral.how_many_level')}}" class="form-control referralLevelGenerate{{ $referral->id }}">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="d-none referralLevelForm{{ $referral->id }}">
                                <div class="form-group">
                                    <label class="text-success"> {{__('messages.referral.level_and_commission')}} :              <small>({{__('messages.referral.old_levels_will_remove_after_generate')}})</small>
                                    </label>
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary btn-block my-3">{{ __('messages.submit') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
